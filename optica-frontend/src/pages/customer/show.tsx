		...
		>
			<Row gutter={[32, 32]}>
				...
				<Col flex={2}>
					...
					<Typography.Text>{dayjs(record?.date).format("DD-MM-YYYY")}</Typography.Text>
					<Title level={5}>Fecha prometida</Title>
					<Typography.Text>{dayjs(record?.targetDate).format("DD-MM-YYYY")}</Typography.Text>
				</Col>
			</Row>
			<Divider></Divider>
			<Row gutter={[32, 32]}>
				<Col flex={5}>
					...
					<Typography.Text>{record?.doctor ? record?.doctor : "-"}</Typography.Text>
					<Title level={5}>Obra Social</Title>
					<Typography.Text>{record?.healthCare ? record?.healthCare : "-"}</Typography.Text>
					<Title level={5}>Nro Afiliado</Title>
					<Typography.Text>{record?.healthCareId ? record?.healthCareId : "-"}</Typography.Text>
				</Col>
			</Row>
			...
			<Row gutter={[32, 32]}>
				...
				<Col flex={1}>
					...
					<Typography.Text>{record?.farColor ? record?.farColor : "-"}</Typography.Text>
				</Col>
				<Col flex={1}>
					<Title level={5}>DI</Title>
					<Typography.Text>{record?.farDI ? record.farDI : "-"}</Typography.Text>
				</Col>
			</Row>
			<Row gutter={[32, 32]}>
				<Col span={5}>
				...
				<Col span={9}>
					...
					<Typography.Text>{record?.farFrame ? record?.farFrame : "-"}</Typography.Text>
				</Col>
			</Row>
			...
			<Row gutter={[32, 32]}>
				...
				<Col flex={1}>
					<Title level={5}>Color</Title>
					<Typography.Text>{record?.closeColor ? record?.closeColor : "-"}</Typography.Text>
				</Col>
				<Col flex={1}>
					<Title level={5}>DI</Title>
					<Typography.Text>{record?.closeDI ? record?.closeDI : "-"}</Typography.Text>
				</Col>
			</Row>
			<Row gutter={[32, 32]}>
				<Col span={5}>
				...
				<Col span={9}>
					<Title level={5}>Armazón</Title>
					<Typography.Text>{record?.closeFrame ? record?.closeFrame : "-"}</Typography.Text>
				</Col>
			</Row>
			...
			<Row gutter={[32, 32]}>
				<Col flex={1}>
					...
					<Typography.Text>{record?.bifocal ? record?.bifocal : "-"}</Typography.Text>
				</Col>
				<Col flex={1}>
			...
			<Row>
				<Col flex={1}>
					...
					<Typography.Text>{record?.metallic ? record?.metallic : "-"}</Typography.Text>
				</Col>
			</Row>
			<Divider></Divider>
			<Row>
				<Col flex={1}>
					...
					<Typography.Text>{record?.notes ? record?.notes : "-"}</Typography.Text>
				</Col>
			</Row>
		</Show>
	);
